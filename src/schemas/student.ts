...
export const studentSchema = z.object({
    rut:z.string().min(7,{message:"minimo 7 digitos sin letras"}).max(8,{message:"Maximo 8 digitos sin letras"}).nonempty("El campo no puede estar vacio").refine(value => [...value].every(char => "0123456789".includes(char)), {
